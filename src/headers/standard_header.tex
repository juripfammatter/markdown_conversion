% document setup
\usepackage[left=7mm,right=7mm,top=15mm,bottom=7mm,portrait]{geometry} % margin = .. total={280mm,190 mm} % in geometry for defined size/ratio
...
% language
\usepackage[english, german]{babel} %choose your language
...
% not exam relevant
\newenvironment{nicetohave}{\color{gray}}{}
